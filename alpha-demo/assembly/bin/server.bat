...
java -Xrunjdwp:transport=dt_socket,address=7700,server=y,suspend=n ^
    ...
    -Dcom.techsenger.alpha.core.mode="server" ^
    ...
    -Dcom.techsenger.alpha.core.script="server-boot.script" ^
    -Djava.net.preferIPv4Stack=true ^
    -Djava.io.tmpdir=%ROOT_PATH%\temp ^
    -Djna.tmpdir=%ROOT_PATH%\temp ^
    -Dfile.encoding=UTF-8 ^
    -Djavax.net.ssl.keyStore=%ROOT_PATH%\bin\${server.keystore.file} ^
    -Djavax.net.ssl.trustStore=%ROOT_PATH%\bin\${server.truststore.file} ^
    -Djavax.net.ssl.keyStorePassword="${server.keystore.password}" ^
    -Djavax.net.ssl.trustStorePassword="${server.truststore.password}" ^
