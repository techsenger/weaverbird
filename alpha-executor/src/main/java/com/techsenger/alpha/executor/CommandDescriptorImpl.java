...
import com.techsenger.alpha.spi.command.MainParameter;
...
class CommandDescriptorImpl extends DefaultCommandInfo implements CommandDescriptor {
    ...
    private final transient CommandFactory factory;

    CommandDescriptorImpl(Class<? extends Command> commandClass, CommandFactory factory) {
    ...
    /**
     * Only executor can have access to factory as only it can create commands.
     * @return
     */
