...
public class ComponentBuildCommand extends AbstractComponentReferenceCommand {
    ...
    public void execute(CommandContext context, MessagePrinter printer) throws Exception {
        ...
        var archivePath = Framework.getComponentManager().buildComponent(getName(), getVersion(), p, extension);
