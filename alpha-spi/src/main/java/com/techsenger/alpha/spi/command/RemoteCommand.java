...
/**
 * Indicates that a command is remote and can only be executed in a framework instance running in server mode
 * when the command is invoked from a framework instance running in client mode.
 *
