 ...
 */
class AttributeWindowViewModel extends AbstractWindowViewModel {
    ...
    AttributeWindowViewModel(Map<String, List<StyledText>> descriptionsByAttribute, AttributeWindowType type) {
        super();
