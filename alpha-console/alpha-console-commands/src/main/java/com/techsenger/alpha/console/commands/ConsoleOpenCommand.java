 ...
 */
@LocalCommand
@CommandMeta(name = "console:open", description = "Opens console.")
public class ConsoleOpenCommand extends AbstractCommand {
    ...
    public void execute(final CommandContext context, MessagePrinter printer) throws Exception {
        ConsoleService service = ServiceUtils
                ...
                .orElseThrow();
        service.open();
        printer.printlnMessage("Console was opened");
    }
}
