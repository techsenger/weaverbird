...
import com.techsenger.toolkit.http.handler.AbstractLoginHandler;
...
public class LoginHandler extends AbstractLoginHandler<FrameworkRequestContext> {
    ...
    @Override
    protected Version getVersion(FrameworkRequestContext context) {
        return context.getFramework().getVersion();
    }
