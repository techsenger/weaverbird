...
module com.techsenger.alpha.net.client.commands {
    requires jcommander;
    ...
    opens com.techsenger.alpha.net.client.commands to jcommander, com.techsenger.alpha.executor;

    provides com.techsenger.alpha.spi.command.CommandFactory
            with com.techsenger.alpha.net.client.commands.CommandFactoryProvider;
