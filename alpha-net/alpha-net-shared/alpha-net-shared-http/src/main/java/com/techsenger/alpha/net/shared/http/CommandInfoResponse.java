 ...
 */
public class CommandInfoResponse extends AbstractResponse {

    private CommandInfos commandInfos;

    public CommandInfoResponse(CommandInfos infos, Exception exception) {
        super(exception);
