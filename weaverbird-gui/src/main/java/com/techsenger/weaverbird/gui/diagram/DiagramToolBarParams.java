 ...
 */
public class DiagramToolBarParams extends SessionToolBarParams {
    ...
    public DiagramToolBarParams(ClientService client, ClientSession session, DiagramToolBarAwarePort toolBarAware) {
    ...
    public DiagramToolBarAwarePort getToolBarAware() {
        return toolBarAware;
    }
