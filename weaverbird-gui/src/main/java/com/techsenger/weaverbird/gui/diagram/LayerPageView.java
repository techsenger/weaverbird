 ...
 */
public class LayerPageView<VM extends LayerPageViewModel<?>> extends AbstractPageView<VM> {
    ...
    public LayerPageView(VM viewModel) {
        super(viewModel);
    }

    @Override
    public void requestFocus() {
        // the layer page itself never takes focus
    }
    ...
    private void buildTableRows() {
        table.setItems(FXCollections.observableArrayList(getViewModel().getModuleAdapters()));
    }
