...
/**
 * This exception it thrown on client, when there was any non security exception on server side.
...
public class RemoteCommandException extends Exception {
    ...
    public RemoteCommandException(String message, Throwable cause, boolean enableSuppression,
