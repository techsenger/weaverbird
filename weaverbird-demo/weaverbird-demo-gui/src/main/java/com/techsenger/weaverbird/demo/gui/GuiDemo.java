    ...
    public static void main(String[] args) throws Exception {
        ...
        if (os != null) {
            if (os == OperatingSystem.WINDOWS) {
                componentManager.getConfigInfo().put("javafx.classifier", "win");
            } else {
                componentManager.getConfigInfo().put("javafx.classifier", os.toString().toLowerCase());
            }
        }

        resolveAndStartComponent(framework, "weaverbird-repo");
        resolveAndStartComponent(framework, "weaverbird-server");
        resolveAndStartComponent(framework, "weaverbird-gui");
    }
