...
import com.techsenger.alpha.core.module.DefaultModuleDirective;
import com.techsenger.alpha.core.repo.DefaultRepositoryDescriptor;
...
public class ConfigXmlReader {
    ...
    private static class SaxHandler extends DefaultHandler {
        ...
        private void processConfigTag(Attributes attributes) throws SAXException {
            ...
            this.config = new DefaultComponentConfig(title, name, new Version(version), componentType);
