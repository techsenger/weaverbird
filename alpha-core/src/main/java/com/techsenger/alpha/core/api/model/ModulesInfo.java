...
public interface ModulesInfo {
    ...
    /**
     * Returns modules by layer name in LinkedHashMap to keep order.
     *
     * @return list of modules.
     */
    Map<String, List<ModuleModel>> getModulesByLayerName();

    /**
     * The state the components when modules info was created.
     */
