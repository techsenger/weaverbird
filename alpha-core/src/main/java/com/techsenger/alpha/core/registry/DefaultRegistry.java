...
package com.techsenger.alpha.core.registry;
...
public class DefaultRegistry implements Registry {
    ...
    private InstallResultEntry installResult;
    ...
    @Override
    public InstallResultEntry getInstallResult() {
    ...
    public synchronized void setInstallResult(InstallResultEntry installResult) {
    ...
    public synchronized void save() {
        try {
            ...
            var path = this.pathProvider.getDataDirectoryPath().resolve(REGISTRY_FILE);
            writer.write(path);
    ...
    private void read() {
        try {
            ...
            var dataPath = this.pathProvider.getDataDirectoryPath();
