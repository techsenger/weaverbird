 ...
 */
public class ThreadInfoListResponse implements Response {

    private List<ThreadInfoModel> threadInfos;

    public ThreadInfoListResponse() {

    }

    public ThreadInfoListResponse(List<ThreadInfoModel> threadInfos) {
